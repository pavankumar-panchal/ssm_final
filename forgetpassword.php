    ...
    <tr>
      <td valign="middle">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <td>
              <form id="submitform" name="submitform" method="post" action="">
                <table width="25%" border="0" align="center" cellpadding="3" cellspacing="0">
                  ...
                  <tr bgcolor="#e2e1e1">
                    <td colspan="2" height="2" style="padding:0"><img src="images/space.gif" width="1" height="2" />
                    </td>
                  </tr>
                  <tr bgcolor="#a9a9a9">
                    <td colspan="2" height="3" style="padding:0"><img src="images/space.gif" width="1" height="3" />
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2" style="padding:0">
                      <table width="100%" border="0" cellspacing="0" cellpadding="4" style="border:1px solid #a9a9a9;"
                        bgcolor="#F8F8F8">
                        <tr>
                          <td colspan="2" bgcolor="#F8F8F8" id="form-error">
                            <div align="center">
                              <?php if ($message <> '')
                                echo ($message); ?>
                            </div>
                        ...
                        <tr>
                          ...
                          <td bgcolor="#F8F8F8"><input name="username" type="text" class="form-fileds" id="username"
                              size="25" /></td>
                        </tr>
                        <tr>
                          <td bgcolor="#F8F8F8">Email ID:</td>
                          <td bgcolor="#F8F8F8"><input name="emailid" type="text" class="form-fileds" id="emailid"
                              size="25" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td colspan="2" align="center" bgcolor="#F8F8F8"><input name="send" type="submit"
                              class="swiftchoicebutton-red" id="send" value="Send Details" />
                            &nbsp;&nbsp;&nbsp;
                            <input name="reset" type="reset" class="swiftchoicebutton-red" id="reset" value="Reset"
                              onclick="clearinnerhtml();" />
                          </td>
                        </tr>
                        <tr>
                          <td colspan="2" align="center" bgcolor="#F8F8F8"><a href="#">Go Back to Lgin Page</a><a
                              href="#"></a></td>
                        </tr>
                      </table>
                    </td>
                  ...
                  <tr bgcolor="#e2e1e1">
                    <td colspan="2" height="2" style="padding:0"><img src="images/space.gif" width="1" height="3" />
                    </td>
                  </tr>
                </table>
              </form>
          ...
          <tr>
            <td align="center" class="page-footer">A product of Relyon Web Management | Copyright © 2008 Relyon Softech
