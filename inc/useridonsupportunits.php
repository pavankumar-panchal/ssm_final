...
if($usertype == 'MANAGEMENT' || $usertype == 'ADMIN')
	...
	$query = "SELECT username,slno,fullname FROM ssm_users WHERE type <> 'ADMIN' and supportunit = '".$supportunits."' and existinguser = 'yes'  order by field(ssm_users.supportunit,".$loggedsupportunit.") desc, ssm_users.fullname;";
