<form name="fileuploadform"  id="fileuploadform" action="../inc/fileupload.php" method="post" enctype="multipart/form-data" target="upload_target" onsubmit="startUpload();" >
