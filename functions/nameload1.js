...
function loadnamesetselect(cusid,cusname,category,type,date,time,state,email,place)
{
	document.getElementById('selectvaluehidden').value = escapesinglequotes(cusid) + "^" + escapesinglequotes(cusname) + "^" + escapesinglequotes(category) + "^" + escapesinglequotes(type) + "^" + escapesinglequotes(date) + "^" + escapesinglequotes(time) + "^" + escapesinglequotes(state)+ "^" + escapesinglequotes(email)+ "^" + escapesinglequotes(place);
}
...
function loadpasscuidname(hiddenid)
{
	...
	if(document.getElementById('email')) document.getElementById('email').value = temp[7];
	if(document.getElementById('place')) document.getElementById('place').value = temp[8];
	var registertype = document.getElementById('hiddenregisterinfo').value;
	if(registertype == ('call' || 'email' || 'skype'))
	{
