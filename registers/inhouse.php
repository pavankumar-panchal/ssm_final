                      ...
                      <tr>
                        <td width="50%" valign="top" style="border-right:1px solid #d1dceb;">
                          <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr bgcolor="#f7faff">
                              <td valign="top" bgcolor="#EDF4FF">Product group(<font color="#FF0000">Optional</font>)
                              </td>
                              <td valign="top" bgcolor="#EDF4FF">
                        ...
                        <td width="50%" valign="top">
                          <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr bgcolor="#f7faff">
                              ...
                              <td valign="top"><input name="billno" type="text" class="swifttext" id="billno" size="30"
                            ...
                            <tr bgcolor="#edf4ff">
                              ...
                              <td valign="top"><input name="acknowledgementno" type="text" class="swifttext"
                                  id="acknowledgementno" value="" size="30" maxlength="20" autocomplete="off" <?php if ($usertype == 'GUEST' || $usertype == 'HR') { ?> disabled="disabled" <?php } ?> /></td>
                            </tr>
                            <tr bgcolor="#f7faff">
                              <td valign="top">Remarks:</td>
                              <td valign="top"><textarea name="remarks" cols="45" class="swifttextarea" id="remarks"
                                  <?php if ($usertype == 'GUEST' || $usertype == 'HR') { ?> disabled="disabled" <?php } ?>></textarea></td>
                            </tr>
                            <tr bgcolor="#edf4ff">
                      ...
                      <td width="50%" valign="top" style="border-right:1px solid #d1dceb;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top" bgcolor="#F7FAFF"><input name="s_customername" type="text"
                          ...
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top" bgcolor="#EDF4FF"><input name="s_problem" type="text" class="swifttextarea"
                                id="s_problem" value="" size="30" /></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top" bgcolor="#F7FAFF">Compliant ID:</td>
                            <td valign="top" bgcolor="#F7FAFF"><input name="s_complaintid" type="text" class="swifttext"
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top" bgcolor="#F7FAFF"><select name="s_userid" id="s_userid"
                                class="swiftselect">
                      ...
                      <td width="50%" valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top" bgcolor="#F7FAFF"><input name="s_acknowledgementno" type="text"
                                class="swifttext" id="s_acknowledgementno" value="" size="30" autocomplete="off" /></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
